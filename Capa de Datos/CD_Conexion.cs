...
namespace Sistema_Mercadito.Capa_de_Datos
{
    public class CD_Conexion
    {
        ...
        public void SEL_REPORTE_DETALLE_RETIROS_EXCEL(int pId, ref DataTable pDtVentas)
        {
            try
            {
                // Ejecutar el comando y obtener el lector de datos
                ...
                SqlDataAdapter da = new SqlDataAdapter("SP_Reporte_Detalle_Retiros_Excel", AbrirConexion());
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.Add("@idCaja", SqlDbType.Int).Value = SharedResources._idCajaAbierta;
                DataSet ds = new DataSet();
                ds.Clear();
        ...
        public void SEL_REPORTE_DETALLE_COMPRA_DOLARES_EXCEL(int pId, ref DataTable pDtVentas)
        {
            try
            {
                // Ejecutar el comando y obtener el lector de datos
                ...
                SqlDataAdapter da = new SqlDataAdapter("[SP_Reporte_Detalle_Compra_Dolares_Excel]", AbrirConexion());
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
                da.SelectCommand.Parameters.Add("@idCaja", SqlDbType.Int).Value = SharedResources._idCajaAbierta;
                DataSet ds = new DataSet();
                ds.Clear();
